...
interface FixedIncomeListItemProps {
  template: FixedIncome;
  onEdit: () => void;
  onToggleActive: () => void;
  onDelete: () => void;
}

/** Una fila de la lista de plantillas de ingresos fijos, con sus acciones — mismo diseño que `FixedExpenseListItem`. */
export function FixedIncomeListItem({ template, onEdit, onToggleActive, onDelete }: FixedIncomeListItemProps) {
  return (
