 ...
 * monto/categoría/día, activar/desactivar). Vive fuera de Configuración a
 * propósito: es parte del flujo de Mensual (de ahí se llega acá), no un
...
export default function GastosFijosPage() {
  ...
  return (
    <div className="flex flex-col gap-5 px-5 pt-6 pb-4">
      <header>
        <h1 className="font-heading text-xl font-semibold">Gastos fijos</h1>
